...
internal sealed class AppDbContextModelSnapshot : ModelSnapshot
{
    protected override void BuildModel(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("Langoose.Domain.Models.ContentFlag", entity =>
        {
        ...
        modelBuilder.Entity("Langoose.Domain.Models.DictionaryItem", entity =>
        {
            entity.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid");
        ...
        modelBuilder.Entity("Langoose.Domain.Models.ExampleSentence", entity =>
        {
            entity.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid");
        ...
        modelBuilder.Entity("Langoose.Domain.Models.ImportRecord", entity =>
        {
            entity.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid");
        ...
        modelBuilder.Entity("Langoose.Domain.Models.ReviewState", entity =>
        {
            entity.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid");
        ...
        modelBuilder.Entity("Langoose.Domain.Models.SessionToken", entity =>
        {
            entity.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid");
        ...
        modelBuilder.Entity("Langoose.Domain.Models.StudyEvent", entity =>
        {
            entity.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid");
        ...
        modelBuilder.Entity("Langoose.Domain.Models.User", entity =>
        {
            entity.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("uuid");
